            ...
            <div className='bg-[#012A4A]'>
                <div className='lg:w-7/12 mx-auto lg:px-0 px-2'>
                    ...
                    <div className='flex items-center justify-center py-[40px]'>
                        <input className='bg-white lg:py-[28px] py-[18px] lg:px-[40px] px-[10px] lg:w-[422px] outline-none' placeholder='Enter Your Email Address' type="email" />
                        <button className='bg-secondary text-white text-base font-bold lg:py-[28px] py-[18px] lg:px-[36px] px-[15px]'>Subscribe</button>
                    </div>
                    <hr />
